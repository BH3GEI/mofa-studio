...
//! TODO: Replace Dora with VoiceChatEngine
...
// TODO: Replace with VoiceChatEngine
use makepad_widgets::*;
...
pub struct MoFaFMScreen {
    ...
    // TODO: Track VoiceChatEngine state when implemented
    #[rust]
...
impl Widget for MoFaFMScreen {
    fn handle_event(&mut self, cx: &mut Cx, event: &Event, scope: &mut Scope) {
        ...
        if self.audio_timer.is_event(event).is_some() {
            ...
            // TODO: Send buffer status to VoiceChatEngine for backpressure control
            ...
            //     // voice_chat.send_command(VoiceCommand::UpdateBufferStatus { fill_percentage });
            // }
        }
        ...
        if mic_btn.clicked(&actions) {
            ...
            // TODO: Recording indicator - connect to VoiceChatEngine when implemented
            // For now, just show based on mic state
            mic_btn.set_recording(cx, !self.mic_muted);

            // TODO: Send start/stop recording command to VoiceChatEngine
            // if self.mic_muted {
        ...
        if aec_btn.clicked(&actions) {
            ...
            // TODO: Send AEC state to VoiceChatEngine when implemented
            // voice_chat.set_aec_enabled(self.aec_enabled);
        }
        ...
        for action in &actions {
            match action.as_widget_action().cast() {
                MofaHeroAction::StartClicked => {
                    ...
                    // TODO: Implement VoiceChatEngine start when backend is ready
                    ::log::info!("TODO: Start VoiceChatEngine backend");
                }
                MofaHeroAction::StopClicked => {
                    ::log::info!("Screen received StopClicked action");
                    // TODO: Implement VoiceChatEngine stop when backend is ready
                    ::log::info!("TODO: Stop VoiceChatEngine backend");
                }
                MofaHeroAction::None => {}
            }
        }
